...
labels$Label[labels$Name == str_starts(pattern = "spencer")] 


labels['better_labels'] = gsub("'","",labels$Name,)

labels <- labels %>%  mutate(Name = case_when(
  Label == ' \'Spencer\' - \"Spencer Hall\"'	~  "Spencer",
  TRUE ~ as.character(Name)
  
)) %>%
  mutate(better_labels = trimws(better_labels, which = "both"))
...
labels['test_test'] = gsub("'","",labels$Name,)
